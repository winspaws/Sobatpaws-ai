...
Menutup siklus human-in-the-loop Ekosistem Satwa:
...
Jalankan:
    python -m ekosistem_satwa.ml.retrain                 # semua kategori dgn data dokter
    python -m ekosistem_satwa.ml.retrain --category cat  # satu kategori
"""
