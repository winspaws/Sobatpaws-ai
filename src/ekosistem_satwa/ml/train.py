"""Training model symptom -> disease (baseline) untuk Ekosistem Satwa.
...
Jalankan:
    python -m ekosistem_satwa.ml.train            # latih semua kategori
    python -m ekosistem_satwa.ml.train --category dog
"""
