...
from ..vision.schemas import VisionAnalysisRequest, VisionAnalysisResult
...
@router.post("/vision/analyze", response_model=VisionAnalysisResult, dependencies=[Depends(require_vet)])
def agent_vision_analyze(req: VisionAnalysisRequest) -> VisionAnalysisResult:
    """Analisis gambar untuk agent AI — alias praktis dari /api/vision/analyze."""
    try:
        return get_vision_service().analyze_image_base64(
            req.base64_data,
