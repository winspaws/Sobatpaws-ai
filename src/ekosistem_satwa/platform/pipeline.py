...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(description="Ekosistem Satwa pipeline runner")
    ...
    if args.list:
        print(json.dumps({
            "steps": [{"id": s["id"], "track": s["track"], "description": s["description"]}
                      for s in __import__("ekosistem_satwa.platform.manifest", fromlist=["PIPELINE_STEPS"]).PIPELINE_STEPS],
