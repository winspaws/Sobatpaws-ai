"""Manifest platform Ekosistem Satwa — kontrak machine-readable untuk AI agent & CI.
...
PIPELINE_STEPS: list[dict[str, Any]] = [
    {
        ...
        "command": ["python", "-m", "ekosistem_satwa.data_loader"],
        "depends_on": [],
    ...
    },
    {
        ...
        "command": ["python", "-m", "ekosistem_satwa.seed_generator"],
        "depends_on": ["validate_kb"],
    ...
    },
    {
        ...
        "command": ["python", "-m", "ekosistem_satwa.ml.train", "--source", "hybrid"],
        "depends_on": ["validate_kb"],
    ...
    },
    {
        ...
        "command": ["python", "-m", "ekosistem_satwa.ml.retrain"],
        "depends_on": ["train_ml"],
        "outputs": [str(ARTIFACTS_DIR / "models")],
    },
    {
    ...
    },
    {
        ...
        "depends_on": [],
        "outputs": [str(EXCEL_DIR / "EkosistemSatwa_08_Learning.xlsx")],
    },
    {
        "id": "refresh_registry",
        "track": "platform",
        "description": "Perbarui platform registry (lineage model + data)",
        "command": ["python", "-m", "ekosistem_satwa.platform.registry", "--refresh"],
        "depends_on": [],
...
PLATFORM_MANIFEST: dict[str, Any] = {
    "name": "Ekosistem Satwa Smart Data Platform",
    "version": "0.3.0",
    ...
    "data_tracks": {
        "curated_json": {
            ...
            "loader": "ekosistem_satwa.data_loader.load_knowledge_base",
        ...
        "learning_loop": {
            ...
            "retrain": "ekosistem_satwa.ml.retrain",
            "safe_for_agent_edit": False,
        },
    },
    "schema": {
    ...
    "runtime": {
        "api_entry": "ekosistem_satwa.api.main:app",
        "consultation": "ekosistem_satwa.ai.consultation.ConsultationService",
        "suggestion_engine": "ekosistem_satwa.ai.suggestion_engine.SuggestionEngine",
    },
    "agent_guidelines": {
